...
<div class="mt-40 mb-20 h-16 md:h-20 w-full border-2 border-main-white backdrop-blur-lg rounded-md flex items-center justify-around text-main-white shadow-lg">
